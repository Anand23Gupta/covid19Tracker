export class StateDistrict {
    ...
    ArunachalPradeshDistrict: string[] = ["Anjaw", "Changlang", "East Kameng", "East Siang", "Kamle", "Kra Daadi",
        ...
        "Upper Siang", "Upper Subansir", "West Kameng", "West Siang"]
    ...
    KarnatakaDistrict: string[] = ["Bagalkote", "Ballari", "Belagavi", "Bengaluru Rura", "Bengaluru Urban", "Bidar", "Chamarajanagara",
    ...
    OdishaDistrict: string[] = ["Angul", "Balangir", "Balasore", "Bargarh", "Bhadrak", "Boudh", "Cuttack", "Deogarh", "Dhenkanal",
        ...
        "Koraput", "Malkangiri", "Mayurbhanj", "NDRF-ODRF", "Nabarangapur", "Nayagarh", "Nuapada", "Puri", "Rayagada", "Sambalpur",
    ...
    PunjabDistrict: string[] = ["Amritsar", "Barnala", "Bathinda", "Faridkot", "Fatehgarh Sahib", "Fazilka", "Ferozepur", "Gurdaspur",
        "Hoshiarpur", "Jalandhar", "Kapurthala", "Ludhiana", "Mansa", "Moga", "Pathankot", "Patiala", "Rupnagar", "S.A.S. Naga", "Sangrur",
    ...
    UttarakhandDistrict: string[] = ["Almora", "Bageshwar", "Chamoli", "Champawat", "Dehradun", "Haridwar", "Nainital", "Pauri Garhwal", "Pithoragarh",
        "Rudraprayag", "Tehri Garhwal", "Udham Singh Nagar", "Unknown", "Uttarkashi"];
